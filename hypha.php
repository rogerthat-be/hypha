...
?>
		<div style="width:800px;">
			...
			<table style="width:800px;" class="section">
				...
				<tr><th>title</th><td><input name="setupTitle" size="40" value="<?php echo isset($_POST['setupTitle']) ? $_POST['setupTitle'] : ''; ?>" /></td><td class="help">The name of your site as it will appear in the browers title bar.</td></tr>
				<tr><th>base url</th><td><input name="setupBaseUrl" size="40" value="http://<?php echo $_SERVER["SERVER_NAME"].str_replace('/hypha.php', '', $_SERVER["REQUEST_URI"]); ?>" /></td><td class="help">This is the address where the hypha site can be found.</td></tr>
				<tr><th>default page</th><td><input name="setupDefaultPage" size="40" value="<?php echo isset($_POST['setupDefaultPage']) ? $_POST['setupDefaultPage'] : 'home'; ?>" /></td><td class="help">Hypha lets you create wiki style pages which can link to each other. If no particular page is selected the site will default to this page.</td></tr>
				<tr><th>default language</th><td><select name="setupDefaultLanguage"><?php echo $languageOptionList; ?></select></td><td class="help">All pages can be multilingual. If a user does not choose a language the site will default to this language.</td></tr>
				<tr><th>login</th><td><input name="setupUsername" size="40" value="<?php echo isset($_POST['setupUsername']) ? $_POST['setupUsername'] : ''; ?>" /></td><td class="help">This first user account will automatically have admin rights for site maintenance.</td></tr>
				<tr><th>password</th><td><input name="setupPassword" size="40" value="<?php echo isset($_POST['setupPassword']) ? $_POST['setupPassword'] : ''; ?>" /></td><td class="help">The superuser password.</td></tr>
				<tr><th>full name</th><td><input name="setupFullname" size="40" value="<?php echo isset($_POST['setupFullname']) ? $_POST['setupFullname'] : ''; ?>" /></td><td class="help">This name will be used for email messages generated by  the system.</td></tr>
				<tr><th>email</th><td><input name="setupEmail" size="40" value="<?php echo isset($_POST['setupEmail']) ? $_POST['setupEmail'] : ''; ?>" /></td><td class="help">This email adress will be the reply-to address of system sent messages. You may want to use an email alias that forwards messages to all collaborators in the group.</td></tr>
